...
public class BlockRichForestGrassBlock extends ElementsBiomia.ModElement {
	@GameRegistry.ObjectHolder("biomia:richforestgrassblock")
	public static final Block block = null;
	public BlockRichForestGrassBlock(ElementsBiomia instance) {
		super(instance, 4);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("richforestgrassblock"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("biomia:richforestgrassblock", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			...
			setUnlocalizedName("richforestgrassblock");
