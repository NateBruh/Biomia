...
public class BlockBlueRose extends ElementsBiomia.ModElement {
	@GameRegistry.ObjectHolder("biomia:bluerose")
	public static final Block block = null;
	public BlockBlueRose(ElementsBiomia instance) {
		super(instance, 7);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("biomia:bluerose", "inventory"));
	}
